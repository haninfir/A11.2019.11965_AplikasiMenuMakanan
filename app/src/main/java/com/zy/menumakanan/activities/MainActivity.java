...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputData("Pecel Lele", "artikel_1.html");
        inputData("Nasi goreng mercon", "artikel_2.html");
        inputData("Ayam geprek keju", "artikel_3.html");
        inputData("Kari Ayam", "artikel_4.html");
        inputData("Tahu Bulat", "artikel_5.html");
        inputData("Salad Buah", "artikel_6.html");
